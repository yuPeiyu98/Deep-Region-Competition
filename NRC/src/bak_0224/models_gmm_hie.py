...
from .networks_gmm_hie import FgNet, BgNet, SpNet, CEBMNet, DNet_bg, DNet_all
from .networks_gmm_hie import BaseEncoder, T_Z
...
class EABPModel(BaseModel):
    ...
    def forward(self, z):
        ...
        d_grid, a_grid, s_logits = self.sp_net(zs, fg_lat, bg_lat)
        # image composition
